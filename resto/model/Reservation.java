...
public class Reservation implements Serializable
{
  ...
  // line 29 "../../../../../RestoApp v3.ump"
   public boolean doesOverlap(Date requestDate, Time requestTime){
    Date afterD = new Date(System.currentTimeMillis() + (3600 * 1000 * 2));
	Date beforeD = new Date(System.currentTimeMillis() - (3600 * 1000 * 2));
	boolean overlap = true;
   	if (requestDate.after(afterD) || requestTime.after(afterD) || requestDate.before(beforeD) || requestTime.before(beforeD)){
   		overlap = false;
   	}
   	return overlap;
  }
